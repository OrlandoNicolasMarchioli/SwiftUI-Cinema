...
struct MovieDetailView: View {
    @ObservedObject var movieDetailViewModel = MovileDetailViewModel( defaultMovieFetchUseCase: DefaultMovieFetchUseCase(allMoviesRepository: MoviesApiFetch(moviesApi: MoviesApi.getInstance(), movieStoreManager: MoviesCacheStore.getInstance())))
